...
project_name = 'shot146398_ul_june2012' #this directory will be created in base_directory'
...
efit_file_location = '/u/haskeysr/new_from_matt/shot146398/' #efit files will be copied from here
...
MARS_rm_files = 'OUTDATA JACOBIAN'
