...
d = data('/home/srh112/code/pyMARS/other_scripts/shot146388_single2/qmult1.000/exp1.000/marsrun/RUNrfa.vac',I0EXP=I0EXP)
...
c.get_PEST()
c.plot1(inc_phase=0,clim_value=[0,1.2])

d.get_PEST()
d.plot1(inc_phase=0,clim_value=[0,1.2])
