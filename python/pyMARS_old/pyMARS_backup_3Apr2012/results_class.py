...
class data():
    ...
    def extract_single(self):
        ...
        file_name = 'BPLASMA'
        self.BM1,self.BM2,self.BM3,self.Mm = ReadBPLASMA(file_name, self.BNORM, self.Ns,self.s,spline_B23=2)
    ...
    def plot_Bn(self, plot_quantity, axis, start_surface = 0, end_surface = 300, skip = 1,cmap='spectral', wall_grid = 23, plot_coils_switch=0, plot_boundaries = 0):
        ...
        #self.phase_plot = ax2.pcolor(grid_R[start_surface:end_surface:skip,:], grid_Z[start_surface:end_surface:skip,:], num.angle(plot_quantity[start_surface:end_surface:skip,:],deg=True),cmap = cmap)
        ...
        if plot_boundaries ==1:
            #plot_coils(axis)
            plot_surface_lines(axis, grid_R, grid_Z, self.Ns1 + wall_grid,'b-')
            plot_surface_lines(axis, grid_R, grid_Z, self.Ns1,'b--')
