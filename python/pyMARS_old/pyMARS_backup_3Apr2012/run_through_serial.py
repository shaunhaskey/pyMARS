...
start_from_step = 3 #this step is included
end_at_step = 3 #this step is included



#directory and file details
project_name = 'shot_serial' #this directory will be created in base_directory'
...
# Template names
CORSICA_template_name = 'sspqi_sh3_serial.bas'
...
if start_from_step <=2 and end_at_step>=2:
    ...
    project_dict['sims'] = pyMARS.read_stab_results_serial(file_location)
    ...
    project_dict = cont_funcs.generate_directories_func_serial(project_dict, project_dict['details']['base_dir'])
