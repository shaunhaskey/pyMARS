...
project_name = 'shot138344_comparison' #this directory will be created in base_directory'
...
# Template names
CORSICA_template_name = 'stab_limit_scan.bas'  #'sspqi_sh3.bas'
...
upper_and_lower = 1 #include an upper and lower run
...
#print os.path.abspath(sys.__file__)
