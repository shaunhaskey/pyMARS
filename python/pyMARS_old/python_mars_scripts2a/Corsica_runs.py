...
def corsica_run_setup(input_data):
    os.system('mkdir /scratch/haskeysr/corsica_test7')
    base_dir = '/scratch/haskeysr/corsica_test7/' + input_data[0]
...
def run_corsica(input_list, script_name):
    ...
    for input_data in input_list:#len(list)):
        ...
        script+= command + '\n'
    file_name = open('/scratch/haskeysr/corsica_test7/' +script_name,'w')
...
#    job_string = job_string + '#$ -m e\n'
    ...
    file_name = open('/scratch/haskeysr/corsica_test7/' + script_name+'.job','w')
    file_name.write(job_string)
    file_name.close()

    os.system('chmod +x /scratch/haskeysr/corsica_test7/'+script_name)
