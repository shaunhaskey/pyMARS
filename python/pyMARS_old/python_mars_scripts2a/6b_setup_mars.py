#!/usr/bin/env Python
## Could implement some kind of suspend function....
## Possible variations are FEEDI, n_coils, ROTE, IFEED
...
var_name = 'FEEDI'
var_list = [0]#[-60]#[-120]#[-180]#[-300] #[0, -60, -120, -180, -240, -300]
######### Need to run this file for every var_value you want to use
