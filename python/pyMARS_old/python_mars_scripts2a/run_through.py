...
project_name = 'testing_new_code3'
...
if start_from_step == 1:
    ...
    for i in range(0,len(corsica_list)):
        Corsica_funcs.corsica_run_setup2(corsica_base_dir, corsica_list[i],corsica_settings[i])
    print 'finished corsica setup, starting corsica runs'
                  
    Corsica_funcs.corsica_batch_run(corsica_list, project_dict, corsica_base_dir)
