...
pickle_file = open(project_dir + '3_'+project_name+'_post_chease_new.pickle','r')
...
pickle_file = open(project_dict['details']['base_dir']+'4_'+ project_name +'_post_fxrun_low_beta.pickle','w')
