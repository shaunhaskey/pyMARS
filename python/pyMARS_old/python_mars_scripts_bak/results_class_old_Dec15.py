...
class data():
    def __init__(self, directory,Nchi=513):
    ...
    def extract_single(self):
        ...
        self.FEEDI = get_FEEDI('log_mars')
        self.BNORM = calc_BNORM(self.FEEDI, self.R0EXP)
...
comb_p.get_PEST()
comb_p.plot1(title='terd', fig_name='/u/haskeysr/hello_test2.png',fig_show=0)
